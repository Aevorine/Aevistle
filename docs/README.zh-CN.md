...
| 平台 | 文件 | 说明 |
|---|---|---|
| Windows 10/11 (x64) | `Aevistle-0.1.0-win-x64-setup.exe` | 安装版，会建开始菜单和桌面快捷方式 |
| Windows 10/11 (x64) | `Aevistle-0.1.0-win-x64-portable.exe` | 单文件免安装，可以放 U 盘里直接跑 |
| Android 7.0+ | `Aevistle-0.1.0.apk` | 手机和平板都能装。先在浏览器或文件管理器里允许「安装未知应用」。 |
